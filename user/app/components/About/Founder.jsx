...
const Founder = () => {
    ...
    const text = locale === "ar"
        ...
        : {
            ...
            title: "Founder & CEO",
            description1: "Our journey at 800BatteryPro started from a vision of delivering 100% customer satisfactory and premium car battery services. When it started, we only had 3 technicians and 1 mobile van for roadside assistance; now we are aiming to become one of the leading 24/7 roadside assistance providers in the UAE. With 30+ certified car battery technicians and 20+ Mobile Vans, we provide onsite car battery replacement and boosting services within 25 minutes anywhere in Dubai and Abu Dhabi. We want to offer a complete and international standard of car repair services on market competitive pricing. Our certified technicians are well-experienced in working on all major car brands, including the top American & European car makes. Our technicians are trained to use only OEM-approved spare parts and only install genuine car batteries for your car. There is no hidden cost while we offer Free Battery Testing along with Free Car Inspection to ensure you drive safety on the road.",
