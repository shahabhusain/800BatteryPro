            ...
            <div className='w-[95%] md:w-[85%] lg:w-[80%] mx-auto px-4 sm:px-0 relative z-10'>
                ...
                <div className='text-left animate-fade-in-up'>
                    ...
                    <div className='flex flex-col md:flex-row items-center justify-between mt-4 md:mt-6 gap-6 md:gap-0'>
                        <p className='text-[28px] sm:text-[36px] md:text-[42px] lg:text-[48px] font-bold max-w-full md:max-w-[600px] leading-tight text-left bg-gradient-to-r from-gray-900 to-gray-700 bg-clip-text text-transparent'>
                            {text.title1}{' '}
